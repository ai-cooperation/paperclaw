...
groups = ["Accuracy","Consistency"]
categories = ["Without Bias Correction","With Bias Correction"]
values = np.array([[0.78,0.88],[0.7,0.82]])
errors = np.array([[0.03,0.02],[0.04,0.03]])
...
ax.set_title('Impact of Bias Correction on LLM Model Performance and Robustness', fontsize=16, fontweight='bold')
